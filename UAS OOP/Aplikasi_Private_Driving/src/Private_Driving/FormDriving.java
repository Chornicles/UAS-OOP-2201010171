 ...
 * @author Gung Ardi
 */
public class FormDriving extends javax.swing.JFrame {
    Driving service;
    int index;
    int tag = 0;
    /**
    ...
    public boolean val() {
        return !nama.getText().isEmpty() && !hp.getText().isEmpty() && !alamat.getText().isEmpty() && !status.getText().isEmpty() && !kelas.getText().isEmpty() && !tp.getText().isEmpty() && !jumlah.getText().isEmpty() && !instruktur.getText().isEmpty();
    } 
    public void save() {
        try {
            if (val()) {
                Driving1 a = new Driving1();
                a.setnama(nama.getText());
                a.sethp(String.valueOf(hp.getText()));
                a.setalamat(alamat.getText());
                a.setjk(String.valueOf(jk.getSelectedItem()));
                a.setstatus(status.getText());
                a.setkelas(kelas.getText());
                a.settp(Integer.valueOf(tp.getText()));
                a.setjumlah(Integer.valueOf(jumlah.getText()));
                a.setinstruktur(instruktur.getText());
    ...
    public void getRecord() {
        ...
        if (record > 0) {
            ...
            if (selected > 0) {
                ...
                hp.setText(jTable1.getValueAt(index, 1).toString());
                ...
                tp.setText(jTable1.getValueAt(index, 5).toString());
                jumlah.setText(jTable1.getValueAt(index, 6).toString());
                instruktur.setText(jTable1.getValueAt(index, 7).toString());
            } else {
    ...
    private void initComponents() {
        ...
        instruktur = new javax.swing.JTextField();
        ...
        jLabel22.setText("PRIVATE DRIVING");
        ...
        jLabel11.setText("Data Peserta Private Driving");
        ...
        jLabel17.setText("Kelas Pilihan");

        jLabel18.setText("Kelas");

        jLabel19.setText("1x Praktik");

        jLabel20.setText("Jumlah Praktik");

        jLabel21.setText("Instruktur");

        hari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Hari", "SENIN", "SELASA", "RABU", "KAMIS", "JUMAT", "SABTU" }));
        ...
        waktu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Waktu", "7.00-10.00", "11.00-13.00", "14.00-16.00", "17.00-19.00" }));
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jumlah, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
                                    .addComponent(instruktur, javax.swing.GroupLayout.Alignment.LEADING))))
        ...
        jLabel16.setText("4 Kelas Pilihan :");
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ...
        kelas.setText("Dasar");
        tp.setText("25000");
        instruktur.setText("1");
    }//GEN-LAST:event_jLabel12MouseClicked

    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        // TODO add your handling code here:
        kelas.setText("Lanjutan");
        tp.setText("50000");
        instruktur.setText("2");
    }//GEN-LAST:event_jLabel13MouseClicked

    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        // TODO add your handling code here:
        kelas.setText("Khusus");
        tp.setText("75000");
        instruktur.setText("3");
    }//GEN-LAST:event_jLabel14MouseClicked

    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        // TODO add your handling code here:
        kelas.setText("Simulasi");
        tp.setText("100000");
        instruktur.setText("4");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDriving.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDriving().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField instruktur;
