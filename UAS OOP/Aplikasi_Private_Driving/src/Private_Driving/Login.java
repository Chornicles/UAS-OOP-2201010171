...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Selamat Datang di Aplikasi Private Driving!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (a.equals("Childe") && b.equals("Legion")) {
            JOptionPane.showMessageDialog(null, "Login kamu sukses"); 
            new FormDriving().setVisible(true);
            this.setVisible(false);        
        }else if (a.equals("origami")) {
            JOptionPane.showMessageDialog(null, "Password Salah"); 
        }else if (b.equals("indonesia")) {
